...
local open = false 
local mainMenu6 = RageUI.CreateMenu('Garage', 'dgstf')
...
Citizen.CreateThread(function()
    while true do
        ...
        for k,v in pairs(position) do
			...
			if ESX.PlayerData.job and ESX.PlayerData.job.name == 'dgstf' then
...
Citizen.CreateThread(function()
    ...
    SetBlipSprite (blip, 476) -- Model du blip
    ...
    AddTextComponentSubstringPlayerName('DGSTF') -- Nom du blip
